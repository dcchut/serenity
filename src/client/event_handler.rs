...
pub trait EventHandler : Send + Sync {
    ...
    #[cfg(feature = "cache")]
    async fn guild_member_removal(&self, _ctx: Context, _guild: GuildId, _user: User, _member_data_if_available: Option<Member>) {}
    ...
    async fn guild_members_chunk(&self, _ctx: Context, _guild_id: GuildId, _offline_members: HashMap<UserId, Member>) {}
