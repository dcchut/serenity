...
impl Guild {
    ...
    #[cfg(feature = "client")]
    #[inline]
    pub async fn ban<U: Into<UserId>, BO: BanOptions>(
        &self,
    ...
    #[cfg(feature = "cache")]
    #[inline]
    pub async fn greater_member_hierarchy<T, U>(
        &self,
        cache: impl AsRef<CacheRwLock>,
        lhs_id: T,
        rhs_id: U,
    ...
    pub fn members_nick_containing(
        ...
        if sorted {
            members.sort_by(|a, b| {
                let name_a = match a.nick {
                    Some(ref nick) => Cow::Borrowed(nick),
                    None => Cow::Owned(a.user.read().name.clone()),
                };
    ...
    async fn _user_permissions_in(&self, channel_id: ChannelId, user_id: UserId) -> Permissions {
    ...
    /// [Ban Members]: ../permissions/struct.Permissions.html#associatedconstant.BAN_MEMBERS
    #[cfg(feature = "client")]
    pub async fn unban<U: Into<UserId>>(
        &self,
        cache_http: impl CacheHttp,
        user_id: U,
    ) -> Result<()> {
